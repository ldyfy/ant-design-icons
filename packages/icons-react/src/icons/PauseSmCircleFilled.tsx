...
const PauseSmCircleFilledSvg: any = {
  icon: {
    tag: "svg",
...
const PauseSmCircleFilled = (
  props: AntdIconProps,
  ref: React.MutableRefObject<HTMLSpanElement>
) => <AntdIcon {...props} ref={ref} icon={PauseSmCircleFilledSvg} />;

PauseSmCircleFilled.displayName = "PauseSmCircleFilled";
